...
public final class Collector {
    ...
    public static HerokuJvmMetrics collect()  {
        ...
        for (GarbageCollectorMXBean garbageCollectorMXBean : ManagementFactory.getGarbageCollectorMXBeans()) {
            ...
            HerokuJvmMetrics.GcMetrics gcm
                    = new HerokuJvmMetrics.GcMetrics(garbageCollectorMXBean.getCollectionCount(), garbageCollectorMXBean.getCollectionTime() / 1000.0);
    ...
    private static long getBufferPoolMemoryUsed(String name) {
        ...
        Logger.logDebug("collector", String.format("Buffer pool '%s' not found. Memory used will be reported as 0!", name));
