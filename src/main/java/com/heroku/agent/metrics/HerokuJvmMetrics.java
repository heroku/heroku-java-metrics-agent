...
public final class HerokuJvmMetrics {
  ...
  public HerokuJvmMetrics(
      long heapUsedBytes,
      long nonHeapUsedBytes,
      long heapCommittedBytes,
      long nonHeapCommittedBytes,
      long directBufferPoolUsedBytes,
      long mappedBufferPoolUsedBytes,
      Map<Gc, GcMetrics> gcMetrics) {
  ...
  public static final class GcMetrics {
    ...
    public boolean equals(Object o) {
      ...
      return collectionCount == gcMetrics.collectionCount
          && Double.compare(gcMetrics.collectionTimeInSeconds, collectionTimeInSeconds) == 0;
    }
